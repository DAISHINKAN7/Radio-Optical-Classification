"""
Train EfficientNet-B0 on LoTSS Dataset
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train EfficientNet-B0 on LoTSS')
    
    # Data
    parser.add_argument('--data_path', type=str, default='data/beautiful_dataset_v2',
                       help='Path to dataset')
    parser.add_argument('--output_dir', type=str, default='outputs/efficientnet',
                       help='Output directory')
    
    # Training
    parser.add_argument('--batch_size', type=int, default=12,
                       help='Batch size (smaller for EfficientNet)')
    ...
    # Print configuration
    print("\n" + "="*60)
    print("EFFICIENTNET-B0 LOTSS TRAINING")
    print("="*60)
    print(f"\nConfiguration:")
