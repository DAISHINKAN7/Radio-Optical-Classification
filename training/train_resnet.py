"""
Train ResNet-34 on LoTSS Dataset
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train ResNet-34 on LoTSS')
    
    # Data
    parser.add_argument('--data_path', type=str, default='data/beautiful_dataset_v2',
                       help='Path to dataset')
    parser.add_argument('--output_dir', type=str, default='outputs/resnet',
    ...
    # Print configuration
    print("\n" + "="*60)
    print("RESNET-34 LOTSS TRAINING")
    print("="*60)
    print(f"\nConfiguration:")
    ...
    val_transform = CombinedTransform(preprocessing, None)  # No augmentation for validation
